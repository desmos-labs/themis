...
class telegramTest(unittest.TestCase):
    ...
    def test_validate_json(self):
        ...
        for json in jsons:
            result = telegram.validate_json(json['json'])
    ...
    def test_verify_signature(self):
        tests = [
            {
                'name': 'Valid data',
                'valid': True,
                'data': telegram.VerificationData(
                    '',
        ...
        for test in tests:
            result = telegram.verify_signature(test['data'])
    ...
    def test_verify_address(self):
        ...
        for test in tests:
            result = telegram.verify_address(test['data'])
            self.assertEqual(test['valid'], result, test['name'])
